...
import { BottomTagLineBlockData } from '../api/BottomTagLineBlock.js';

class BottomTagLineBlock extends TrackeReact(Component){
	...
	submit(event){
		...
		Meteor.call('addUpdateBottomTagLine', formValues, (err, res)=>{
			if(err){
				swal('Error: ',err);
			}else{
				if(res == 'updated'){
				        ...
				        <div className="row">
				          <div className="col-lg-12 col-lg-offset-0 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
				            <div className="box box-primary">
				              ...
				              <h2 className="formTitle">Bottom Tag-line</h2>
				              </div>
